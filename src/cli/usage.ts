...
export function usage(): string {
    ...
    return [
        ...
        "  --anonymous-function-spacing <on|off>",
        "                              Override anonymous function spacing",
        "  --named-function-spacing <on|off>",
        "                              Override named function/method spacing",
        "  --control-keyword-spacing <on|off>",
        "                              Override control-flow keyword spacing",
        "  --check                     Report only; exit non-zero if any file would change",
        "",
